class WineTypesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to wine_types_path, status: :see_other, notice: "Wine type was successfully destroyed." }
  ...
  private
    ...
    def wine_type_params
      params.require(:wine_type).permit(:name, :image_url, :description)
    end
end
